package de.hsrm.lback.myapplication.domains.location.views.overview;
...
import de.hsrm.lback.myapplication.domains.gpslist.GpsListActivity;
import de.hsrm.lback.myapplication.domains.journey.views.overview.JourneyOverviewActivity;
...
import de.hsrm.lback.myapplication.domains.location.views.edit.EditLocationActivity;
...
public class LocationOverview extends AppCompatActivity implements LocationViewModel.ViewHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.gridArrayAdapter = new LocationAdapter(this, locations, locationService, getApplication(), R.layout.component_location_layout);
    ...
    private void openAnonymousEditView(int requestCode) {
        Intent intent = new Intent(this, EditLocationActivity.class);
        intent.putExtra(Location.LOCATION_UID, ANONYMOUS_UID);
